    ...
    for root, dirs, files in os.walk(input_dir):
        ...
        for file in files:
            if file.endswith('.npy'):
                ...
                # Save directly to image using matplotlib's seismic colormap
                plt.imsave(
                    output_image_path,
                    section_data.T,
                    cmap='seismic',
...
output_dir = 'sections_color'  # The folder where the pictures are stored
export_sections_to_images(input_dir, output_dir)
print(f"All sections have been exported as color png images and saved to the folder: {output_dir}")
